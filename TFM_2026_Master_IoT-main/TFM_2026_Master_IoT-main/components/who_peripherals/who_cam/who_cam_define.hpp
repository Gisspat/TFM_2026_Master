...
namespace who {
namespace cam {
//      ENUMERACIÓN DE FORMATOS DE COLOR UNIFICADOS EN EL FRAME BUFFER
enum class cam_fb_fmt_t { CAM_FB_FMT_RGB565, CAM_FB_FMT_RGB888, CAM_FB_FMT_JPEG, CAM_FB_FMT_UKN };

#if CONFIG_IDF_TARGET_ESP32S3
//      ADAPTADORES DE CONTROLADOR Y FORMATO EXCLUSIVOS PARA ESP32-S3
// 1. ESCALADO AUTOMÁTICO DE LA IMAGEN EN BASE A LAS DIMENSIONES FÍSICAS DE LA LCD
...
// 2. CONVERTIDOR DE FORMATO PIXFORMAT INTEGRADO (DRIVER ESP-CAMERA -> ABSTRACCIÓN WHO)
...
#endif
//      CONVERTIDOR DE FORMATOS GRÁFICOS INTERNOS DE LA PILA DE DEEP LEARNING (ESP-DL)
...
//      CONVERTIDOR DE FORMATOS PARA ACCESO POR STREAMING USB (CÁMARAS EXTERNAS UVC)
...
//      CONVERTIDOR DE FORMATOS V4L2 DE KERNEL DE ALTO RENDIMIENTO (ESP32-P4)
...
#endif
//      ESTRUCTURA DE DATOS DEL FRAME BUFFER UNIFICADO (POLIMORFISMO DE IMAGEN)
typedef struct cam_fb_s {
    ...
    cam_fb_s() = default;
#if CONFIG_IDF_TARGET_ESP32S3
// CONSTRUCTOR SOBRECARGADO: ABSORCIÓN DE DATOS DE LA CÁMARA NATIVA DEL S3
...
#endif
// CONSTRUCTOR SOBRECARGADO: MAPEO DE IMÁGENES PROVENIENTES DE CÁMARA USB UVC
...
// CONSTRUCTOR SOBRECARGADO: CONVERSIÓN DE ESTRUCTURAS MATRICIALES PROPIAS DE IA
...
// OPERADOR DE REPARSEO AUTOMÁTICO: TRANSFORMA LA IMAGEN CRUDA A UN TENSOR PARA LA CNN
